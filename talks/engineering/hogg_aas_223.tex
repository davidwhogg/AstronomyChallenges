...
\begin{frame}
  \includegraphics<1->[width=0.32\textwidth,clip=]{single_data_200_i_202_ri_gr.png}
  \includegraphics<2->[width=0.32\textwidth,clip=]{dc_fluxdist_resample_200_i_202_20_ri_gr.png}
  \includegraphics<3->[width=0.32\textwidth,clip=]{coadd_data_200_i_202_ri_gr.png}
\end{frame}
