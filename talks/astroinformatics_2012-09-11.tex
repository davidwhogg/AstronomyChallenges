...
\begin{frame}
  ...
  \item map:
    ...
    \item think: Search document for ``kittens''; return DocumentID
      and PageRank if it hits.
  ...
  \item reduce:
    ...
    \item think: Compare two PageRanks and return DocumentID and
...
\begin{frame}
  ...
  \item \emph{non-parametric} shear map or distribution function
    ...
    \item think: As you observe more and more galaxies, with better
      redshift estimates, you increase the angular and redshift
